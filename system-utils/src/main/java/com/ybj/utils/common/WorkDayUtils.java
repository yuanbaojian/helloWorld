...
public class WorkDayUtils {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("开始日：" + calStart.get(Calendar.YEAR) + "-" + (calStart.get(Calendar.MONTH) + 1)
					+ "-" + calStart.get(Calendar.DAY_OF_MONTH) + " " + app.getChineseWeek(calStart));
			System.out.println("结束日：" + calEnd.get(Calendar.YEAR) + "-" + (calEnd.get(Calendar.MONTH) + 1)
					+ "-" + calEnd.get(Calendar.DAY_OF_MONTH) + " " + app.getChineseWeek(calEnd));
